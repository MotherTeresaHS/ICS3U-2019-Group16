...
project = u'OverAchiever Website'
copyright = u'2020, Trinity Armstrong'
...
latex_documents = [
  ('index', 'toga.tex', u'OverAchiever Website',
   u'Trinity Armstrong', 'manual'),
]
...
man_pages = [
    ('index', 'CBPS', u'OverAchiever Website',
     [u'Mr. Coxall'], 1)
]
